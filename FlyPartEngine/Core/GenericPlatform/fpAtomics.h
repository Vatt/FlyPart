...
public:
    ...
    virtual FORCEINLINE int32 InterlockedExchangeAddImpl(volatile int32* Addend, int32 Value) = 0;
    ...
    virtual FORCEINLINE int64 InterlockedExchangeAddImpl(volatile int64* Target, int64 Value) = 0;
#endif
...
public:
	...
	{
        _atomicsImpl->InterlockedIncrementImpl(Addend);
	}
    ...
    {
        return _atomicsImpl->InterlockedExchangeAddImpl(Addend, Value);
    }
	...
	{
        _atomicsImpl->InterlockedAddImpl(Addend, Value);
	}
