...
public:
    ...
    FORCEINLINE int32 InterlockedExchangeAddImpl(volatile int32* Addend, int32 Value)override;
    ...
    FORCEINLINE int64 InterlockedExchangeAddImpl(volatile int64* Addend, int64 Value)override;
#endif
